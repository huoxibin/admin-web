            ...
            if (sort) {
              if (price) {
                ...
                for (let i = 0; i < subList.length; i++) {
                  ...
                  subList[i].packageId = this.id;
                  subList[i].id =
                    subList[i].id === undefined ? -1 : subList[i].id;
                }
                this.$post(
                  "/data/new",
                  this.$qs.stringify({
