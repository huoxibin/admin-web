  ...
  <div class="health comment">
    <base-layout ref="layout" :form="form" @getData="getData">
      ...
      <div slot="btns" class="pull-right">
        ...
        <el-button type="primary" size="mini" @click="dialogVisible = true">导入</el-button>
        <el-button type="primary" size="mini" @click="downloadTemplate">导入模板</el-button>
        <el-button type="primary" size="mini" @click="$router.push('/client/list/add')">新增</el-button>
      </div>
      <!-- 表格 -->
      <dk-table
        slot="table"
