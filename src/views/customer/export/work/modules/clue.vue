  ...
  <el-card class="work-order-card" shadow="hover">
    ...
    >
      <el-form-item label="接入渠道">
        <el-input v-model="form.joinChannel" maxlength="50" disabled></el-input>
      </el-form-item>
      ...
      <el-form-item label="联系方式1" prop="contactTelOne">
        <el-input v-model="form.contactTelOne" maxlength="50"></el-input>
      </el-form-item>
      <el-form-item label="联系人2" prop="contactNameTwo">
        <el-input v-model="form.contactNameTwo" maxlength="50"></el-input>
      </el-form-item>
      <el-form-item label="联系方式2" prop="contactTelTwo">
      ...
      <el-form-item label="联系方式3" prop="contactTelThree">
      ...
      <el-form-item label="所属省市" prop="city">
        <div class="area" style="width: 100%;display: flex;">
          <el-select v-model="form.province" placeholder="请选择" @change="handleArea">
            <el-option
      ...
      <el-form-item label="申请区域" prop="countyId">
        <div class="area" style="width: 100%;display: flex;">
          <el-select v-model="form.provinceId" placeholder="请选择" @change="handleAreas">
            <el-option
          ...
          <el-select v-model="form.cityId" placeholder="请选择" @change="handleCitys">
            <el-option
              v-for="item in citys"
              :key="item.cityId"
              :label="item.cityName"
      ...
      <el-form-item label="来源" prop="clueSource">
        <div class="clue-source" style="display: flex;">
          ...
          <el-input v-if="form.clueSource === 4" v-model="form.rest" maxlength="50"></el-input>
        </div>
      </el-form-item>
