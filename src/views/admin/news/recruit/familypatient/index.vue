...
export default {
  ...
  data() {
    return {
			tableHeight:0,
      form: {
        pathL: "/doctor/recruitPatient/listFamily",
        infoName: "",
        doctorName: "",
        patientName: "",
        mobile: "",
      ...
      headers: {
        ...
        pathL: "/doctor/recruitPatient/importExcelFamily"
      },
      importData: {},
      excelName: "",
      sendNumber: null
  ...
  methods: {
    ...
    // 导出excel
    exportExcel() {
      exportExcel("doctor/recruitPatient/exportFamily", this.form);
    },
    // 导入excel
    importExcel() {
    ...
    // 下载excel模板
    downExcelTemplate() {
      window.open(`https://jkywoss-udoctor-new.oss-cn-beijing.aliyuncs.com/common/excel%E6%A8%A1%E6%9D%BF/%E6%8B%9B%E5%8B%9F%E6%82%A3%E8%80%85%E9%97%AE%E5%8D%B7%EF%BC%8D%E5%8C%BB%E5%93%86%E5%92%96%E5%AF%BC%E5%85%A5%E6%A8%A1%E7%89%88.xlsx`)
    },
    // 预览
    preview(id) {
      this.$router.push({
